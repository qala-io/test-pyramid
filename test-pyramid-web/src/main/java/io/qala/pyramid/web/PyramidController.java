...
class PyramidController {
    PyramidController(PyramidRest pyramidRest) {
        ...
        pyramidService.save(new PyramidDto(new Pyramid().setName("Straight Pyramid").
                setUnitTests(3).setComponentTests(2).setSystemTests(1)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("Ice-Cream Cone")
                .setUnitTests(1).setComponentTests(2).setSystemTests(3)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("Unit Square")
                .setUnitTests(1)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("Two Squares")
                .setUnitTests(1).setSystemTests(1)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("System Square")
                .setSystemTests(1)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("Diamond")
                .setUnitTests(1).setComponentTests(2).setSystemTests(1)));
        pyramidService.save(new PyramidDto(new Pyramid().setName("Current Project Pyramid")
